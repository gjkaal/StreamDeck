...
namespace OpenMacroBoard.SDK
{
    ...
    public static class KeyBitmapBasicFactoryExtensions
    {
        ...
        {
            ValidateParameters(keyFactory, width, height);
        ...
        private static void ValidateParameters(IKeyBitmapFactory keyFactory, int width, int height)
        {
            if (keyFactory == null)
            {
                // keyFactory is not required
            }
