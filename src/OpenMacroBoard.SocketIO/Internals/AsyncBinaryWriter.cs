...
namespace OpenMacroBoard.SocketIO.Internals
{
    ...
    {
        public static readonly AsyncBinaryWriter Null = new();
...
#pragma warning disable 169
        [OptionalField]
        private readonly char[]? _tmpOneCharBuffer;
#pragma warning restore 169
        ...
        public virtual async Task<Stream> GetBaseStreamAsync(CancellationToken cancellationToken = default)
        {
        ...
        // 
        public virtual Task WriteAsync(bool value, CancellationToken cancellationToken = default)
        {
        ...
        // advanced by one.
        // 
        public virtual Task WriteAsync(byte value, CancellationToken cancellationToken = default)
        {
        ...
        // is advanced by one.
        // 
        public virtual Task WriteAsync(sbyte value, CancellationToken cancellationToken = default)
        {
        ...
        // 
        public virtual Task WriteAsync(byte[] buffer, CancellationToken cancellationToken = default)
        {
            if (buffer == null)
        ...
        // method to write the byte array.
        // 
        public virtual Task WriteAsync(byte[] buffer, int index, int count, CancellationToken cancellationToken = default)
        {
        ...
        // 
        public unsafe virtual Task WriteAsync(char ch, CancellationToken cancellationToken = default)
        {
        ...
        // 
        public virtual Task WriteAsync(char[] chars, CancellationToken cancellationToken = default)
        {
            if (chars == null)
        ...
        // method to write the character array.
        // 
        public virtual Task WriteAsync(char[] chars, int index, int count, CancellationToken cancellationToken = default)
        {
        ...
        public unsafe virtual Task WriteAsync(double value, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Task WriteAsync(decimal value, CancellationToken cancellationToken = default)
        {
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
        ...
        // 
        public virtual Task WriteAsync(short value, CancellationToken cancellationToken = default)
        {
        ...
        // 
        public virtual Task WriteAsync(ushort value, CancellationToken cancellationToken = default)
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            return OutStream.WriteAsync(_buffer, 0, 2, cancellationToken);
        ...
        // 
        public virtual Task WriteAsync(int value, CancellationToken cancellationToken = default)
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
        ...
        // of the stream is advanced by four.
        // 
        public virtual Task WriteAsync(uint value, CancellationToken cancellationToken = default)
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            _buffer[2] = (byte)(value >> 16);
        ...
        // 
        public virtual Task WriteAsync(long value, CancellationToken cancellationToken = default)
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            _buffer[2] = (byte)(value >> 16);
        ...
        // 
        public virtual Task WriteAsync(ulong value, CancellationToken cancellationToken = default)
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            _buffer[2] = (byte)(value >> 16);
        ...
        // 
        [System.Security.SecuritySafeCritical]  // auto-generated
        public unsafe virtual Task WriteAsync(float value, CancellationToken cancellationToken = default)
        {
        ...
        // 
        //[System.Security.SecuritySafeCritical]  // auto-generated
        public virtual async Task WriteAsync(string value, CancellationToken cancellationToken = default)
        {
            if (value == null)
            ...
            if (len <= _largeByteBuffer.Length)
            {
                ...
                await OutStream.WriteAsync(_largeByteBuffer.AsMemory(0, len), cancellationToken).ConfigureAwait(false);
            }
            else
            {
                ...
                while (numLeft > 0)
                {
                    ...
                    checked
                    {
                        ...
                        {
                            throw new ArgumentOutOfRangeException(nameof(value), "string value contains no characters");
                        }
...
#endif
                    await OutStream.WriteAsync(_largeByteBuffer.AsMemory(0,byteLen), cancellationToken).ConfigureAwait(false);
                    charStart += charCount;
                    numLeft -= charCount;
                }
#if _DEBUG
